namespace FestivalApp.Models
{
    public class Rave
    {
        ...
        public Rave() { }
        public Rave (int id, string name, string location, DateOnly date, string website, int minimum_age, string ticket_link, string description, string time, byte[] image)
        {
            _Id = id;
            _Name = name;
            _Location = location;
